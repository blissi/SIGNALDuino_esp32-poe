...
*/
  ...
  #elif defined(ESP32)
    #define PIN_RECEIVE          36   // D13 | G13 (depending on type / clone / seller) --> old 16, not good (serial) and not all boards n.c.
    #define PIN_LED              3    // D2  | G2 (depending on type / clone / seller)
